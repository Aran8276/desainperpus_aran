...
namespace desainperpus_aran
{
    ...
    WHERE 
        ...
        [peminjaman_buku].[jml_pinjam] LIKE '%' + @search + '%' OR
        [peminjaman].[tgl_pinjam] LIKE '%' + @search + '%' OR
        [pengembalian].[tgl_kembali] LIKE '%' + @search + '%' OR
        [pengembalian].[denda] LIKE '%' + @search + '%'
    ";
                    ...
                    dataGridView1.Columns[0].Visible = false; // nis
                    dataGridView1.Columns[1].Visible = false; // id_buku
                    dataGridView1.Columns[2].Visible = false; // id_user
                    dataGridView1.Columns[3].Visible = false; // id_peminjaman_buku
                    dataGridView1.Columns[4].Visible = false; // id_peminjaman
                    dataGridView1.Columns[5].HeaderText = "Peminjam"; // nama
                    dataGridView1.Columns[6].HeaderText = "Judul Buku"; // judul_buku
                    dataGridView1.Columns[7].HeaderText = "Jumlah Pinjam"; // jml_pinjam
                    dataGridView1.Columns[8].HeaderText = "Tanggal Pinjam"; // tgl_pinjam
                    dataGridView1.Columns[9].HeaderText = "Durasi Pinjam"; // durasi_pinjam
                    dataGridView1.Columns[10].HeaderText = "Tanggal Kembali"; // tgl_kembali
                    dataGridView1.Columns[11].HeaderText = "Denda"; // denda
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Error: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
    ...
    AND [siswa].[nis] = '" + selectedNis + "'";
        ...
        private void bSavePeminjaman_Click(object sender, EventArgs e)
        {
            insertData();
        }
